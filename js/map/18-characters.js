      ...
      <div>
        <div class="list-item">
          ...
          <div class="list-item-actions">
            <button class="icon-btn" onclick="event.stopPropagation(); openCharacterModal(${c.id})" title="Редактировать">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
            </button>
            <button class="icon-btn" onclick="event.stopPropagation(); deleteCharacter(${c.id})" title="Удалить" style="color:var(--danger)">
  ...
  return `
    <div class="list-item-expanded">
      ...
      <div class="expanded-actions" style="margin-top:8px;">
        <button class="btn btn-sm btn-primary" onclick="spawnCharacterToken(${c.id})">На карту</button>
        <button class="btn btn-sm" onclick="openCharacterModal(${c.id})">Изменить</button>
      </div>
    </div>
  `;
}
