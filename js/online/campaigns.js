...
(function(){
  ...
  window.openOnlinePanel = function(){
    ...
    // Если уже подключены к комнате — показываем именно комнату,
    // а не экран создания/входа. Сначала нужно выйти.
  ...
  window.dndOnlineCan = function(action){
    ...
    if(!role) return true; // офлайн-режим сохраняет старое поведение
        ...
        <div class="online-room-head">
          <div>
            ...
            <div class="online-role">
              ${state.player.role === 'master' ? '👑 Мастер' : '🎲 Игрок'}
            </div>
          </div>
